// Generated by eXtraCoffeeScript 1.4.0
(function() {
  var CACHE, FileServer, PORT, fs, http, path, svr, url, zlib;
  ...
  FileServer = (function() {
    ...
    FileServer.prototype.serve = function(_arg) {
      var caching, file, req, res, url, _accept_gz, _file, _ref, _ref1,
        _this = this;
      ...
      if (_file.gz && !_accept_gz) {
        ...
        if (_file._data != null) {
          ...
          zlib.gunzip(_file.data, function(err, _data) {
            if (err) {
